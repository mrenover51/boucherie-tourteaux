...
export function Footer() {
  return <footer className="bg-bordeaux-dark pb-20 text-white xl:pb-0"><Container className="py-16 sm:py-20">
    <div className="grid gap-12 border-b border-white/14 pb-14 md:grid-cols-2 xl:grid-cols-[1.2fr_.8fr_1fr_1.25fr]">
      <div><Logo light/><p className="mt-6 max-w-xs text-sm leading-7 text-white/58">Boucherie à Avize, au cœur de la Côte des Blancs, avec service traiteur, livraison et vente à emporter.</p><Link href="/boucherie-autour-avize" className="mt-7 inline-flex items-center border border-gold/35 px-4 py-3 text-[.57rem] font-bold tracking-[.14em] text-gold">AUTOUR D’AVIZE ET D’ÉPERNAY</Link></div>
